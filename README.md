# jre-install-trusted-cert
Utility to download and install server cert into JRE trusted cert store
...
and updated by Eric Cline at [InstallCert.java](https://github.com/escline/InstallCert)
...
```
./bin/install-cert [--proxy=proxyHost:proxyPort] <host>[:port] [passphrase]
```
